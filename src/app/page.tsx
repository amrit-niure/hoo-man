...
export default function LandingPage() {
  ...
  return (
    <div className="flex flex-col border-4 border-yellow-600 w-full">
      <header
        className={`sticky top-0 z-50 w-full backdrop-blur-lg transition-all duration-300 max-w-7xl mx-auto ${isScrolled ? "bg-background/80 shadow-sm" : "bg-transparent"}`}
      >
      ...
      <main className=" w-full mx-auto flex flex-col gap-10 md:gap-20 ">
          ...
          <div className="container px-4 md:px-6 relative">
            ...
            >
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-6 bg-clip-text text-transparent bg-gradient-to-r from-foreground to-foreground/70">
                Elevate Your Workflow with Hooo-man
              </h1>
        ...
        {/* Pricing Section */}
        <section id="pricing" className="w-full bg-muted/30 py-20 relative overflow-hidden">
          <div className="absolute inset-0 -z-10 h-full w-full bg-white dark:bg-black bg-[linear-gradient(to_right,#f0f0f0_1px,transparent_1px),linear-gradient(to_bottom,#f0f0f0_1px,transparent_1px)] dark:bg-[linear-gradient(to_right,#1f1f1f_1px,transparent_1px),linear-gradient(to_bottom,#1f1f1f_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_80%_50%_at_50%_50%,#000_40%,transparent_100%)]"></div>
